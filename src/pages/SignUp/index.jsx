  ...
  return (
    <>
      <div className="bg-deep_purple-900 h-[1080px] mx-auto relative w-full">
        ...
        >
          <div className="flex flex-col items-center justify-start md:ml-[0] ml-[74px] mt-[26px] w-[37%] md:w-full">
            <div className="bg-white-A700 border-2 border-blue_gray-50 border-solid flex flex-col items-start justify-start md:px-10 sm:px-5 px-[84px] py-[83px] rounded-[24px] w-auto md:w-full">
              <div className="flex flex-col items-start justify-start w-full">
                <div className="flex flex-col font-inter gap-[9px] items-start justify-start w-auto sm:w-full">
                  <Text
                ...
                <div className="flex flex-col font-inter gap-4 items-start justify-start mt-[42px] w-full">
                  <Text
                  ...
                  <Input
                    name="groupFour"
                    placeholder="Ronald"
                    className="font-medium leading-[normal] p-0 placeholder:text-blue_gray-600 text-left text-xl w-full"
                ...
                <div className="flex flex-col font-inter gap-4 items-start justify-start mt-[19px] w-full">
                  <Text
                    className="text-gray-900 text-xl w-auto"
                    size="txtInterSemiBold20"
                  >
                ...
                <div className="flex flex-col font-inter gap-4 items-start justify-start mt-[18px] w-full">
                  <Text
                    className="text-gray-900 text-xl w-auto"
                    size="txtInterSemiBold20"
                  >
                  ...
                  <Input
                    name="email_One"
                    placeholder="ronald.john@gmail.com"
                    className="font-medium leading-[normal] p-0 placeholder:text-blue_gray-600 text-left text-xl w-full"
                    wrapClassName="border-2 border-blue_gray-50 border-solid w-full"
                    type="email"
                    onChange={(e) => {
